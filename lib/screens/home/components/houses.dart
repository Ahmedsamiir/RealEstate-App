...
import 'package:real_estate/screens/details/details_screen.dart';
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        icon: house.isFav! ? const Icon(Icons.favorite_rounded, color: red,)
                            : const Icon(Icons.favorite_border_rounded, color: black,),
                        onPressed: (){
                          setState(() {
